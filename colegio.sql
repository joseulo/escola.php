...
--
-- Host: localhost:3306
-- Tempo de geração: 26-Jun-2023 às 06:19
...
(1, 'Agostinho Augusto', 'RH', 982344213, 'augusto@gmail.com', 'Gestor', 'Luanda Sul', 31),
(2, 'José Ulo', 'Segurança', 925222497, 'joseulo77@gmail.com', 'Segurança', 'Viana', 20),
(3, 'Celestino Mateus', 'RH', 923454637, 'cele@gmail.com', 'Gestor', 'Rocha', 26);
...
INSERT INTO `usuario` (`idusuario`, `nome`, `nivel_acesso`, `senha`) VALUES
(1, 'Manuel Sampaio', 1, '123'),
(2, 'Hernany Zua', 1, '2345'),
(3, 'José Ulo', 2, '2023'),
(4, 'Jair Fernandes', 2, 'ws23'),
(5, 'Miguel Setas', 2, '2123'),
(6, 'José Correia', 1, '00jc');
